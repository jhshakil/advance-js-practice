...
for (const key of Object.keys(newItem)) console.log(key);
for (const value of Object.values(newItem)) console.log(value);
for (const entry of Object.entries(newItem)) console.log(entry);
